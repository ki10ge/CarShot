...
def call_gpt(image_buf: io.BytesIO, prompt: str) -> bytes:
        ...
        messages=[
            {
                ...
                "content": [
                    ...
                    },
                    {
                        "type": "text",
                        "text": (
                            "Analyze this car photo in detail. Describe: "
                            "1. Exact make, model, trim level "
                            "2. Exact exterior color and paint finish (metallic, matte, glossy) "
                            "3. Wheel/rim design and color "
                            "4. Body style and any special features or badges "
                            "5. Camera angle and perspective (front-left, front-right, side, etc) "
                            "6. Current lighting conditions on the car body "
                            "Be very precise. Only describe the car itself, ignore the background."
                        )
                    }
                ]
            }
    ...
    car_desc = vision.choices[0].message.content

    # Schritt 2: DALL-E 3 mit vollstaendigem Prompt
    dalle_prompt = (
        "Professional dealership showroom photograph of the following car: " + car_desc + ". "
        "CRITICAL: Keep the exact car shape, proportions, color, rims, and all details "
        "100% realistic and unchanged. Do not alter anything on the car itself. "
        "Replace the background with a modern high-end car showroom interior: "
        "clean architecture, large glass windows with soft natural daylight coming from the side, "
        "minimalistic design, polished floor with subtle reflections of the car. "
        "Lighting: soft diffused light, realistic reflections on the car body, "
        "glossy premium finish, no harsh shadows. "
        "Quality: ultra sharp, high dynamic range HDR, realistic reflections and highlights, "
        "professional automotive photography style. "
        "The car is the main focus, no distortion, no unrealistic changes, "
        "no added or removed parts. "
        "Style: luxury car advertisement, dealership presentation, clean and premium aesthetic. "
        "No people, no other vehicles, no text in image."
    )
